...
vim.keymap.set({ "n", "t", "i" }, "<C-Up>", "<cmd>resize +2<cr>")
vim.keymap.set({ "n", "t", "i" }, "<C-Down>", "<cmd>resize -2<cr>")
vim.keymap.set({ "n", "t", "i" }, "<C-Left>", "<cmd>vertical resize -2<cr>")
vim.keymap.set({ "n", "t", "i" }, "<C-Right>", "<cmd>vertical resize +2<cr>")
